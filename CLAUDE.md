...
The app is three big files — `eth-tracker.html` (6,335 lines), `cloudflare-worker/worker.js`
(2,255), `README.md` (1,489) — with no modules to navigate by. **Read the map before opening
the code**, not after.
