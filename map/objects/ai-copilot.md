---
type: part
source: eth-tracker.html:4743-4822, cloudflare-worker/worker.js:835-1119
status: verified
universe: live
risk: picks
...
| Function | Line | Does |
|---|---|---|
| `marketContext` | 4743 | assembles what the model is told |
| `aiWorthIt` | 4769 | **the spend gate** — decides whether this round is worth paying for |
| `callWorker` | 4793 | the request (paid, or `crowdOnly`) |
| `applyCrowd` | 4822 | folds the reply in |
...
**Hits**
- [probability-engine](probability-engine.md) — `aiOver:2181` consumes this read as one of six
  signals. It is weighted, not decisive.
- **Cost.** `aiWorthIt:4769` is the only thing between the app and unbounded spend. Loosening
