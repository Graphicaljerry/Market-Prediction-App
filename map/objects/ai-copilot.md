---
type: part
source: eth-tracker.html:4795-4874, cloudflare-worker/worker.js:835-1119
status: verified
universe: live
risk: picks
...
| Function | Line | Does |
|---|---|---|
| `marketContext` | 4795 | assembles what the model is told |
| `aiWorthIt` | 4821 | **the spend gate** — decides whether this round is worth paying for |
| `callWorker` | 4845 | the request (paid, or `crowdOnly`) |
| `applyCrowd` | 4874 | folds the reply in |
...
**Hits**
- [probability-engine](probability-engine.md) — `aiOver:2233` consumes this read as one of six
  signals. It is weighted, not decisive.
- **Cost.** `aiWorthIt:4821` is the only thing between the app and unbounded spend. Loosening
