...
| Function | Line | Does |
|---|---|---|
| `betMath` | 2556 | the arithmetic |
| `measuredAtPrice` | 5625 | historical hit rate at a given price |
| `slipRow` | 5714 | renders the row |
...
**Hits** — [pick-surface](pick-surface.md), since `renderHero:5753` calls `slipRow:5714`.
